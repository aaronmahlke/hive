...
<template>
  <DialogRoot v-model:open="open">
    ...
    <DialogPortal>
      ...
      <DialogContent
        :class="[
          'bg-base-1 fixed top-[50%] left-[50%] z-100 max-h-[85vh] w-[90vw] translate-x-[-50%] translate-y-[-50%] rounded-[14px] p-0.5 shadow-2xl focus:outline-none',
          maxWidthClasses[size],
        ]"
      >
        <div class="bg-base-2 border-neutral rounded-xl border">
          <DialogTitle
            class="text-primary border-neutral border-b px-4 py-3 text-copy font-medium"
          >
            <slot name="title" />
          </DialogTitle>
